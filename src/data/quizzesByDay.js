...
export const quizzesByDay = {
  ...
  20: [
    ...
    },
    {
      "id": 7,
      "category": "데이터 모델링 마스터",
      "question": "다음 중 관계(Relationship)의 표기법인 'Crow's Foot'의 해석으로 부적절한 것은?",
      "options": [
        {
          "id": 1,
        ...
        {
          "id": 2,
          "text": "기호 '<' (까마귀발) 모양은 1:N 관계에서 'Many' 쪽을 나타낸다.",
          "isCorrect": false
        },
        {
          "id": 3,
        ...
        {
          "id": 4,
          "text": "선택사양(Optionality)은 데이터가 존재하지 않을 수도 있음을 의미한다.",
          "isCorrect": false
        }
      ],
      "rationale": "'O'는 선택 참여(Optional)를 의미하며, '|'가 필수 참여(Mandatory)를 의미합니다.",
      "hint": "원(O)은 '0'을 의미합니다. 데이터가 0개여도 된다는 건 필수일까요, 선택일까요?",
      "tables": [
        {
          "name": "",
          "headers": [
